...
\begin{enumerate}
	...
	\item Eclipse: Usage Data Collector (UDC) collects commands executed in the environment and editors and views that are invoked.
	
	\item Eclipse: Mylyn Monitor collects task oriented events and can be configured for saving data
	
	\item CodingSpectator %https://github.com/vazexqi/CodingSpectator
focuses on refactoring actions and the context in which they are taken.
	...
	\item CodeAlike is a Visual Studio extension for personal analytics and research
