...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{prefPage1}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{filesystem}
...
%		check margins
%		maybe width?
%		try not to have window in foreground
%		constant scaling (can do with scale=.7, etc)
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{upload}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{debugconfig}
