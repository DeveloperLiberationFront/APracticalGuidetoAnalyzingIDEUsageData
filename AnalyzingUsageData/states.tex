%Anil, please rewrite/restructure to match the other sub-sections (e.g., category, magnitude, sequence). The basic outline should be:
%into, including advantages and disadvantages of this approach
%example of this approach, preferrably in someone else's papers
