...
%\lstinputlisting[caption=Abstract Monitored Event, label=code:AbstractMonitoredEvent,   float=h]{C:/Workspace/VisualStudioMonitor-Step2/Monitor/AbstractMonitoredEvent.cs}
...
%\lstinputlisting[caption=MonitoredCommandEvent,  label=code:MonitoredCommandEvent,  float=h]{c:/Workspace/VisualStudioMonitor-Step2/Monitor/MonitoredCommandEvent.cs}
...
%\lstinputlisting[caption=MonitoredEventFactory,  label=code:MonitoredEventFactory,  float=h]{c:/Workspace/VisualStudioMonitor-Step2/Monitor/MonitoredEventFactory.cs}
...
%\lstinputlisting[caption=MonitoredEventCollection,  label=code:MonitoredEventCollection,  float=h]{c:/Workspace/VisualStudioMonitor-Step2/Monitor/MonitoredEventCollection.cs}
\end{enumerate}
\end{Answer}
...
%\lstinputlisting[caption=AbstractMonitoredEvent,  label=code:AbstractMonitoredEvent_4,  float=h]{c:/Workspace/VisualStudioMonitor-Ex4/Monitor/AbstractMonitoredEvent.cs}
...
%\lstinputlisting[caption=MonitoredCommandEvent,  label=code:MonitoredCommandEvent_4,  float=h]{c:/Workspace/VisualStudioMonitor-ex4/Monitor/MonitoredCommandEvent.cs}
...
%\lstinputlisting[caption=MonitoredEventCollection,  label=code:MonitoredEventCollection_4,  float=h]{c:/Workspace/VisualStudioMonitor-ex4/Monitor/MonitoredEventCollection.cs}

\item
The DataRecorder class was modified in this exercise, see the listing \ref{code:DataRecorder_4}.
%\lstinputlisting[caption=DataRecorder,  label=code:DataRecorder_4,  float=h]{c:/Workspace/VisualStudioMonitor-ex4/Monitor/DataRecorder.cs}
\end{enumerate}
\end{Answer}
