...
%TODO(Will Snipes): Please add the .cs file to the repo.
%\lstinputlisting[caption=Abstract Monitored Event, label=code:AbstractMonitoredEvent,   float=h]{VisualStudioMonitor-Step2/Monitor/AbstractMonitoredEvent.cs}
...
%TODO(Will Snipes): Please add the .cs file to the repo.
%\lstinputlisting[caption=MonitoredCommandEvent,  label=code:MonitoredCommandEvent,  float=h]{VisualStudioMonitor-Step2/Monitor/MonitoredCommandEvent.cs}
...
%TODO(Will Snipes): Please add the .cs file to the repo.
%\lstinputlisting[caption=MonitoredEventFactory,  label=code:MonitoredEventFactory,  float=h]{VisualStudioMonitor-Step2/Monitor/MonitoredEventFactory.cs}
...
%TODO(Will Snipes): Please add the .cs file to the repo.
%\lstinputlisting[caption=MonitoredEventCollection,  label=code:MonitoredEventCollection,  float=h]{VisualStudioMonitor-Step2/Monitor/MonitoredEventCollection.cs}
\end{enumerate}
...
%TODO(Will Snipes): Please add the .cs file to the repository.
%\lstinputlisting[caption=AbstractMonitoredEvent,  label=code:AbstractMonitoredEvent_4,  float=h]{VisualStudioMonitor-Ex4/Monitor/AbstractMonitoredEvent.cs}
...
%TODO(Will Snipes): Please add the .cs file to the repository.
%\lstinputlisting[caption=MonitoredCommandEvent,  label=code:MonitoredCommandEvent_4,  float=h]{VisualStudioMonitor-ex4/Monitor/MonitoredCommandEvent.cs}
...
%TODO(Will Snipes): Please add the .cs file to the repository.
%\lstinputlisting[caption=MonitoredEventCollection,  label=code:MonitoredEventCollection_4,  float=h]{VisualStudioMonitor-ex4/Monitor/MonitoredEventCollection.cs}

\item
The DataRecorder class was modified in this exercise, see the listing \ref{code:DataRecorder_4}.
%TODO(Will Snipes): Please add the .cs file to the repository.
%\lstinputlisting[caption=DataRecorder,  label=code:DataRecorder_4,  float=h]{VisualStudioMonitor-ex4/Monitor/DataRecorder.cs}
\end{enumerate}
