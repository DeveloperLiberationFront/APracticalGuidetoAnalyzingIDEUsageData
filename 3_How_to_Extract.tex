...
\begin{figure}[!t]
\centering
\includegraphics[width=3in]{WDG_example.pdf}
...
\begin{figure}
  \centering
  \includegraphics[scale=.58]{op-profile-example}
  \caption{WDG example}\label{fig:op-profile-example}
\end{figure}
...
\begin{figure}
  \centering
  \includegraphics[scale=.20]{log_with_color}
  \caption{WDG example with probaility}\label{fig:log_with_color}
\end{figure}

\begin{figure}
  \centering
  \includegraphics[scale=.58]{sample_log}
